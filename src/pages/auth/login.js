        ...
        <div className={"login-form"}>
            ...
            <Form action="/">
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control type="email" className="bg-dark text-white" placeholder="Enter email"/>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="password" className="bg-dark text-white" placeholder="Password"/>
                </Form.Group>
